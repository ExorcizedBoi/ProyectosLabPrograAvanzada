...
fun PantallaBoletas() {
    ...
    Column(
        ...
        CampoTextField("RUT Cliente", rutCliente) { rutCliente = it }
        ...
        Row(horizontalArrangement = androidx.compose.foundation.layout.Arrangement.spacedBy(8.dp)) {
            Button(onClick = { }) { Text("Generar Boleta") }
            OutlinedButton(onClick = { }) { Text("Exportar PDF") }
            OutlinedButton(onClick = { }) { Text("Ver Boletas") }
        }
    }
}